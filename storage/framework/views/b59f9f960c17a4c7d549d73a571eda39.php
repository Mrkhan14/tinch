        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0" ><?php echo app('translator')->get('translation.client'); ?></h5>
                    <div class="d-flex">
                        <button
                ...
                <div class="card-body">
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>№.</th>
                                <th><?php echo app('translator')->get('translation.client'); ?></th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a  href="counterparties-cilent-profil"
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="client" class="form-label"><?php echo app('translator')->get('translation.client'); ?></label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\turonsoft.uz\resources\views/counterparties-cilent.blade.php ENDPATH**/ ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0"><?php echo app('translator')->get('translation.settingMeasurement'); ?></h5>
                    <div class="d-flex">
                        <button
                            ...
                            <span data-key="t-cret"><?php echo app('translator')->get('translation.cret'); ?></span>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>№.</th>
                                <th data-key="t-FullName"><?php echo app('translator')->get('translation.FullName'); ?></th>
                                <th data-key="t-nameName"><?php echo app('translator')->get('translation.nameName'); ?></th>
                                <th data-key="t-settingTable"><?php echo app('translator')->get('translation.settingTable'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="fullscreeexampleModalLabel" data-key="t-modalTitCreate" ><?php echo app('translator')->get('translation.modalTitCreate'); ?></h5>
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="nameName1" class="form-label" data-key="t-FullName"><?php echo app('translator')->get('translation.FullName'); ?></label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\turonsoft.uz\resources\views/setting-measurement.blade.php ENDPATH**/ ?>
                ...
                <div class="card-body">
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th><?php echo app('translator')->get('translation.modalTitCreate'); ?></th>
                                <th><?php echo app('translator')->get('translation.settingGuruh'); ?></th>
                                ...
                                <th><?php echo app('translator')->get('translation.cod'); ?></th>

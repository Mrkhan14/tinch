        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">@lang('translation.payments')</h5>
                    <div class="d-flex">
                        <div class="d-flex">
                            <button
                                ...
                                <span>@lang('translation.outgoingPayments')</span>
                            </button>
                        </div>
                        <div class="d-flex ms-3">
                            <button
                                ...
                                class="btn btn-soft-success">
                                <i class="ri-add-circle-line align-middle me-1"></i>
                                <span>@lang('translation.incomingPayments')</span>
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>No.</th>
                                <th>@lang('translation.payments')</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>@lang('translation.incomingPayments')</td>
                                <td>USD </td>
                                <td>11 700</td>
                                <td>9 200 USD</td>
                                <td>03 Oct, 2021</td>
                            ...
                            <tr>
                                ...
                                <td>@lang('translation.outgoingPayments')</td>
                                <td>USD </td>
                                <td>11 700</td>
                                <td>9 200 USD</td>
                                <td>03 Oct, 2021</td>
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-4 col-md-6 col-12">
                                <div>
                                    <label for="hrRol" class="form-label">@lang('translation.client')</label>
                            ...
                            <div class="col-xxl-4 col-md-6 col-12">
                                <div>
                                    <label for="userName" class="form-label">@lang('translation.priceru')</label>
                                    <input type="text" class="form-control" id="userName">
                                </div>
                            </div>
                            <div class="col-xxl-4 col-md-6 col-12">
                                <div>
                                    <label for="NumberBank" class="form-label">@lang('translation.NumberBank')</label>
                            ...
                            <div class="col-xxl-6 col-md-6 col-12">
                                <div>
                                    <label for="typePayment" class="form-label">@lang('translation.typePayment')</label>

            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    aria-controls="sale">
                        ...
                        <i class="ri-shopping-basket-2-line"></i> <span>@lang('translation.sale')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sale">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="sale" class="nav-link">@lang('translation.sale')</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    aria-controls="store">
                        ...
                        <i class="ri-shopping-basket-2-line"></i> <span>@lang('translation.storeTransition')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="store">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="store-transition" class="nav-link">@lang('translation.storeTransition')</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    aria-controls="transactions">
                        ...
                        <i class="lab la-cc-paypal"></i> <span>@lang('translation.transactions')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="transactions">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="transactions-payments" class="nav-link">@lang('translation.payments')</a>
                            </li>
                            <li class="nav-item">
                                <a href="transactions-expenses" class="nav-link">@lang('translation.expenses')</a>
                            </li>
                            <li class="nav-item">
                                <a href="transactions-bank-account" class="nav-link">@lang('translation.bankAccount')</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    aria-controls="counterparties">
                        ...
                        <i class="ri-account-pin-box-line"></i> <span>@lang('translation.counterparties')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="counterparties">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="counterparties-provider" class="nav-link"> @lang('translation.provider') </a>
                            </li>
                            <li class="nav-item">
                                <a href="counterparties-cilent" class="nav-link"> @lang('translation.client') </a>
                            </li>
                        </ul>
                    </div>
                </li>

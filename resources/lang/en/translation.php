...
return [
    ...
    "t-settingPraduk" => "Продукты",
    "t-widgets" => "Dashboard",
    "t-settingCurrencies" => "Валюты ",
    "t-settingCurrenciesKurs" => "Курс ",
    "t-settingCurrenciesName" => "Валюта учета ",
    "t-settingCurrenciesSimvil" => "Символ ",
    "t-FullName" => "Наименование ",
    "t-nameName" => "Полное наименование ",
    "t-settingCurrenciesISO" => "ISO код ",
    "t-settingCurrenciesCheckbox" => "Обратный курс ",
    "t-settingTable" => "Настройки ",
    "t-modalTitCreate" => "Новый ",
    "t-modalTitUpdate" => "Изменить ",
    "t-modalBtnSeve" => "Сохранить ",
    "t-modalBtnClose" => "Закрывать ",
    "t-settingPaymentTypes" => "Тип оплаты ",
    "t-settingCosts" => "Типы расходов",
    "t-settingGuruh" => "Группа",
    "t-settingWarehouses" => "Склад",
    "t-warehouses" => "Складские помещения",
    "t-settingMeasurement" => "Ед. изм",
    "t-hrTitle" => "HR",
    "t-hrUsers" => "Пользователи",
    "t-hrRol" => "Роль ",
    "t-hrALL" => "Увидеть все ",
    "t-hrJust" => "Просто убедитесь сами ",
    "t-userName" => "Имя ",
    "t-userFamil" => "Фамилия ",
    "t-telfon" => "Телефон ",
    "t-status" => "Статус  ",
    ...
    "t-totalSum" => "Итого  ",
    "t-date" => "Дата  ",
    "t-warehousesMoving" => "Переместить Склад ",
    "t-warehousesMoving1" => "Исходящий склад",
    "t-warehousesMoving12" => "Входящий склад",
    "t-praductPart" => "Продукты Партия",
    "t-qanchaKerak" => "Количество",
    "t-detali" => "Детали ",
    "t-delet" => "Удалить",
    "t-Miqdor" => "Количество",
    "t-ProductArrivalPriceru" => "Цена прибытия товара ",
    "t-ProductArrivalPrice" => "Mahsulut kelish narxi ",
    "t-letProductBeTarorru" => "Пусть продукт будет товаром",
    "t-letProductBeTaror" => "Mahsulot taror bo'lshi ",
    "t-client" => "Клиент  ",
    "t-provider" => "Поставщик ",
    "t-counterparties" => "Контрагенты",
    "t-commen" => "Комментарий",
    "t-user" => "Пользователь",
    "t-nameCompany" => "Компании",
    "t-priceru" => "Цена",
    "t-rest" => "Остальные",
    "t-typePayment" => "Тип платежа",
    "t-discounts" => "Скидки",

    "t-transactions" => "Транзакции",
    "t-payments" => "Платежи",
    "t-expenses" => "Расходов",
    "t-bankAccount" => "Номер банковского счета",
    "t-MFO" => "МФО",
    "t-NumberBank" => "Номер банковского",
    "t-cret" => "Создать",
    "t-paidDate" => "Оплаченный дате ",
    "t-axad" => "axad"
];
?>

...
return [
    ...
    "settingCurrenciesKurs" => "Курс ",
    "settingCurrenciesName" => "Валюта учета ",
    "settingCurrenciesSimvil" => "Символ ",
    "FullName" => "Наименование ",
    "nameName" => "Полное наименование ",
    "settingCurrenciesISO" => "ISO код ",
    "settingCurrenciesCheckbox" => "Обратный курс ",
    "settingTable" => "Настройки ",
    "modalTitCreate" => "Новый ",
    "modalTitUpdate" => "Изменить ",
    "modalBtnSeve" => "Сохранить ",
    "modalBtnClose" => "Закрывать ",
    "settingPaymentTypes" => "Тип оплаты ",
    "settingCosts" => "Типы расходов",
    "settingGuruh" => "Группа",
    "settingWarehouses" => "Склад",
    "warehouses" => "Складские помещения",
    "settingMeasurement" => "Ед. изм",
    "hrTitle" => "HR",
    "hrUsers" => "Пользователи",
    "hrRol" => "Роль ",
    "hrALL" => "Увидеть все ",
    "hrJust" => "Просто убедитесь сами ",
    "userName" => "Имя ",
    "userFamil" => "Фамилия ",
    "telfon" => "Телефон ",
    "status" => "Статус  ",
